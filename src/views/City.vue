<!-- city @author lpf -->
<template >
    <div class="cityList city" ref="citylistpage">
        <div>
            <div class="search-bar">
                <div class="search-input-bar">
                  <mt-field placeholder="请输入城市名" type="search" v-model="searchMsg" class="city-input"></mt-field>
        ...
        <div class="fast-sel-bar" v-show="!showSearchInfo">
            <p class="fast-sel-item" :class="{fastSelActive: index === curCityListIndex}"
               ...
               @touchmove.stop.prevent="onSelectFastTouchMove" :key="index">
                {{word}}
            </p>
        </div>
    </div>
...
<script>
/* eslint-disable */
    import {cityList} from '@/configPro/city.js';
...
<style>
   .cityList input.mint-field-core{
      padding-left:4rem !important;
      background: url("../assets/fdj.png") no-repeat left center;
      background-size:10%;
    }
</style>
